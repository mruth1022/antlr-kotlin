...
abstract class Parser(input: TokenStream) : Recognizer<Token, ParserATNSimulator>() {
    ...
    override fun assignInputStream(newValue: IntStream?) {
        this.inputStream = newValue as TokenStream?
    }
...
//     */
    ...
    //
    protected var _precedenceStack: IntegerStack = IntegerStack()
    //
//    /**
...
//     */
    ...
    override var inputStream: IntStream? = null
        get() = tokenStream
        set
...
//
    ...
    companion object {
        ...
        // FIXME: there is no WeakHashMap alternative in Kotlin multiplatform
        private val bypassAltsAtnCache = HashMap<String, ATN>()
    }
}
